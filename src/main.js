...
const dotTexts = [
  "Text for Scientific Fields",
  "Text for Business Fields",
  "Text for Mathematic Fields",
  "Text for Engineering Fields",
  "Text for Technology Fields"
];
...
function onClick(event) {
  ...
  if (intersects.length > 0) {
    ...
    if (intersectedDot instanceof THREE.Mesh) {
